...
const webGpuDeviceSource = await readFile("src/webgpu-device.js", "utf8");
...
assert.match(contentBundle, /getWebGpuDevice/);
assert.match(contentBundle, /subscribeWebGpuDeviceLoss/);
...
assert.doesNotMatch(rendererSource, /device\.destroy\(\)/);
